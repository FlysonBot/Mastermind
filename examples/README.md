...
## Running In Browser: Google Colab

- Open [this link](https://colab.research.google.com/github/FlysonBot/Mastermind/blob/main/examples/mastermind_in_colab.ipynb) to open the program straight in your browser using Google Colab without any installation.
